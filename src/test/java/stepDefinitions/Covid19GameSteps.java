...
public class Covid19GameSteps extends Covid19GameBase {
    ...
    @Given("I launch My browser and Open the  COVID19 GAME Application")
    public void i_launch_my_browser_and_open_the_covid19_the_game_application() {
